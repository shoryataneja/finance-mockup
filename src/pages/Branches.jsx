...
const BRANCHES = [
  {
    id: 1, code: 'NF-BLR-01', name: 'Hosur Road',
    address: 'Hosur Road, Bangalore',
    region: 'South Bangalore', manager: 'Shylaja',
    phone: '+91 80 4567 8901', email: 'hosurroad@nandifinance.in',
    opened: 'Jan 2018', status: 'Active',
    staff: 6, enquiries: 148, sanctioned: 102, rejected: 28, inProgress: 18,
  },
  {
    id: 2, code: 'NF-BLR-02', name: 'Hosur Road Rural Anekal',
    address: 'Anekal, Hosur Road, Bangalore',
    region: 'South Bangalore', manager: 'Shylaja',
    phone: '+91 80 4567 8902', email: 'hosurroad.anekal@nandifinance.in',
    opened: 'Mar 2019', status: 'Active',
    staff: 6, enquiries: 98, sanctioned: 68, rejected: 18, inProgress: 12,
  },
  {
    id: 3, code: 'NF-BLR-03', name: 'Hosur Road Rural Attibele',
    address: 'Attibele, Hosur Road, Bangalore',
    region: 'South Bangalore', manager: 'Shylaja',
    phone: '+91 80 4567 8903', email: 'hosurroad.attibele@nandifinance.in',
    opened: 'Jun 2019', status: 'Active',
    staff: 6, enquiries: 112, sanctioned: 78, rejected: 22, inProgress: 12,
  },
  {
    id: 4, code: 'NF-BLR-04', name: 'Hosur Road Rural Sarjapura',
    address: 'Sarjapura, Hosur Road, Bangalore',
    region: 'South Bangalore', manager: 'Shylaja',
    phone: '+91 80 4567 8904', email: 'hosurroad.sarjapura@nandifinance.in',
    opened: 'Sep 2020', status: 'Active',
    staff: 6, enquiries: 89, sanctioned: 58, rejected: 19, inProgress: 12,
  },
  {
    id: 5, code: 'NF-BLR-05', name: 'B G Road',
    address: 'Bannerghatta Road, Bangalore',
    region: 'South Bangalore', manager: 'Girish',
    phone: '+91 80 4567 8905', email: 'bgroad@nandifinance.in',
    opened: 'Feb 2021', status: 'Active',
    staff: 1, enquiries: 45, sanctioned: 30, rejected: 10, inProgress: 5,
  },
  {
    id: 6, code: 'NF-BLR-06', name: 'White Field',
    address: 'Whitefield, Bangalore – 560066',
    region: 'East Bangalore', manager: 'Harish',
    phone: '+91 80 4567 8906', email: 'whitefield@nandifinance.in',
    opened: 'Jul 2021', status: 'Active',
    staff: 2, enquiries: 76, sanctioned: 52, rejected: 14, inProgress: 10,
  },
  {
    id: 7, code: 'NF-BLR-07', name: 'K P Road',
    address: 'Kanakapura Road, Bangalore',
    region: 'South Bangalore', manager: 'Sunil',
    phone: '+91 80 4567 8907', email: 'kproad@nandifinance.in',
    opened: 'Nov 2019', status: 'Active',
    staff: 5, enquiries: 121, sanctioned: 84, rejected: 24, inProgress: 13,
  },
  {
    id: 8, code: 'NF-BLR-08', name: 'K P Road Rural Kanakapura',
    address: 'Kanakapura, Bangalore Rural',
    region: 'South Bangalore', manager: 'Sunil',
    phone: '+91 80 4567 8908', email: 'kproad.kanakapura@nandifinance.in',
    opened: 'Apr 2020', status: 'Active',
    staff: 5, enquiries: 87, sanctioned: 60, rejected: 18, inProgress: 9,
  },
  {
    id: 9, code: 'NF-BLR-09', name: 'K P Road Rural Ramanagara',
    address: 'Ramanagara, Bangalore Rural',
    region: 'South Bangalore', manager: 'Sunil',
    phone: '+91 80 4567 8909', email: 'kproad.ramanagara@nandifinance.in',
    opened: 'Aug 2020', status: 'Active',
    staff: 5, enquiries: 74, sanctioned: 50, rejected: 15, inProgress: 9,
  },
  {
    id: 10, code: 'NF-BLR-10', name: 'Queens Road',
    address: 'Queens Road, Bangalore',
    region: 'North Bangalore', manager: 'Mahesh',
    phone: '+91 80 4567 8910', email: 'queensroad@nandifinance.in',
    opened: 'Jan 2020', status: 'Active',
    staff: 3, enquiries: 95, sanctioned: 64, rejected: 20, inProgress: 11,
  },
  {
    id: 11, code: 'NF-BLR-11', name: 'Queens Road Rural',
    address: 'Queens Road Rural, Bangalore',
    region: 'North Bangalore', manager: 'Mahesh',
    phone: '+91 80 4567 8911', email: 'queensroad.rural@nandifinance.in',
    opened: 'Jun 2021', status: 'Active',
    staff: 3, enquiries: 62, sanctioned: 42, rejected: 12, inProgress: 8,
  },
  {
    id: 12, code: 'NF-BLR-12', name: 'Banaswadi',
    address: 'Banaswadi, Bangalore',
    region: 'East Bangalore', manager: 'Gajalakshmi',
    phone: '+91 80 4567 8912', email: 'banaswadi@nandifinance.in',
    opened: 'Mar 2021', status: 'Active',
    staff: 4, enquiries: 83, sanctioned: 56, rejected: 17, inProgress: 10,
  },
];
